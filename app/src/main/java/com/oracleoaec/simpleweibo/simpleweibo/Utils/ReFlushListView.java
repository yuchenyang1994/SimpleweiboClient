...
public class ReFlushListView extends ListView implements  OnScrollListener{
    ...
    public ReFlushListView(Context context) {
        super(context);
        init(context);
    }

    public ReFlushListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        headerView = (LinearLayout) inflater.inflate(R.layout.reflush_layout, null);
    ...
    private void changeHeaderViewByState() {
        switch (state) {
            ...
            case DONE:
                ...
                lvHeaderProgressBar.setVisibility(View.GONE);
                lvHeaderArrowIv.clearAnimation();
                lvHeaderArrowIv.setImageResource(R.drawable.bird0_0);
                lvHeaderTipsTv.setText("下拉刷新");
                lvHeaderLastUpdatedTv.setVisibility(View.VISIBLE);
                break;
        }
    ...
    public void onRefreshComplete() {
        state = DONE;
        lvHeaderLastUpdatedTv.setText("最近更新:" + new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()));
        changeHeaderViewByState();
    }
