 ...
 */
public class TickButton extends Drawable {
    ...
    private int mTickColor = Color.YELLOW;
    private int mPlusColor = Color.WHITE;

    public TickButton(int dimensionPixelSize) {
        this(10, Color.BLUE, Color.WHITE);
    }

    public TickButton(int strokeWidth, int tickColor, int plusColor) {
    ...
    private Property<TickButton, Integer> mBackgroundColorProperty = new Property<TickButton, Integer>(Integer.class, "bg_color") {
        @Override
        public Integer get(TickButton object) {
            return object.mBackgroundPaint.getColor();
        }

        @Override
        public void set(TickButton object, Integer value) {
            object.mLinePaint.setColor(value);
        }
    };

    private Property<TickButton, Integer> mLineColorProperty = new Property<TickButton, Integer>(Integer.class, "line_color") {
        @Override
        public Integer get(TickButton object) {
    ...
    private Property<TickButton, Float> mRotationProperty = new Property<TickButton, Float>(Float.class, "rotation") {
        @Override
        public Float get(TickButton object) {
            return object.mRotation;
        }

        @Override
        public void set(TickButton object, Float value) {
    ...
    private abstract class PointProperty extends Property<TickButton, Float> {
